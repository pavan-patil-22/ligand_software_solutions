...
const Profile = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                const res = await axios.get(`https://ligand-software-solutions-63g6.onrender.com/api/users/${userId}`, {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const res = await axios.put(`https://ligand-software-solutions-63g6.onrender.com/api/users/${userId}`, data, {
                headers: { 
    ...
    return (
        <div style={{ maxWidth: "500px", margin: "auto" }}>
            ...
            <img
                src={`https://ligand-software-solutions-63g6.onrender.com/uploads/${user.profilePic}`}
                alt="Profile"
